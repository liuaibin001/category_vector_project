...
class CategoryGenerator:
    def __init__(self, input_csv_path: str, output_json_path: str, api_key: str = None, 
        ...
        # 添加单文件存储目录
        self.single_files_dir = "data/single_file"
        # 确保单文件存储目录存在
...
"""
    ...
    def call_deepseek_api(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Extract content from response - adjust based on actual Deepseek API response format
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', default='data/new_categories.json', help='Output JSON file path (Legacy parameter, data now saved to individual files)')
    parser.add_argument('--api-key', default='sk-61e4615c4f814a1ca24542cca10ce619', help='Deepseek API key (can also use DEEPSEEK_API_KEY env var)')
